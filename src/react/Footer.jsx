export default function Footer() {
  return (
    <footer className="footer">
      <h2 className="footer__title title-secondary">
        Let's build something <br /> great together.
      </h2>
      <button className="footer__btn btn btn--primary">Schedule Call</button>
      <p className="footer__paragraph paragraph">
        Challenge by{' '}
        <a className="footer__link link link--red" href="https://www.frontendmentor.io/">
          Frontend Mentor
        </a>
